...
const InfoCardRoot = forwardRef<HTMLDivElement, InfoCardRootProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
...
const InfoCardSubtitle = forwardRef<HTMLParagraphElement, InfoCardSubtitleProps>(
  ({ className, ...props }, ref) => (
...
const InfoCardSection = forwardRef<HTMLDivElement, InfoCardSectionProps>(
  ({ className, ...props }, ref) => (
