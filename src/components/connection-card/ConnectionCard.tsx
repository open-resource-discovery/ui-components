...
const ConnectionCardHeader = forwardRef<HTMLDivElement, ConnectionCardHeaderProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
...
const ConnectionCardTitle = forwardRef<HTMLHeadingElement, ConnectionCardTitleProps>(
  ({ className, ...props }, ref) => (
...
const ConnectionCardTags = forwardRef<HTMLDivElement, ConnectionCardTagsProps>(
  ({ className, ...props }, ref) => (
