...
const SheetBackdrop = forwardRef<HTMLDivElement, SheetBackdropProps>(
  ({ className, ...props }, ref) => (
    <BaseDialog.Backdrop
      ref={ref}
      className={cn(
...
type SheetPopupProps = ComponentPropsWithoutRef<typeof BaseDialog.Popup> &
  VariantProps<typeof sheetPopupVariants>;

const SheetPopup = forwardRef<HTMLDivElement, SheetPopupProps>(
